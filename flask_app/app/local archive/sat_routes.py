...
def sat_cover():
    ...
    alert_time_utc = request.args.get("alert_time_utc")
    if alert_time_utc:
        alert_df.iloc[0]["alert_time_utc"] = alert_time_utc
    ...
    if sat_overlay_df is None or sat_overlay_df.empty:
        return jsonify({"features": [], "type": "FeatureCollection"}), 200
